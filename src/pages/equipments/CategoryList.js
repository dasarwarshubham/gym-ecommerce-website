			...
			{categories.map((category, idx) => (
				<Row key={`cetegory-${idx}`} className="my-5 py-md-5 mx-0 px-3">
					...
					<Col lg={9} md={7} sm={{ span: 6, order: idx % 2 === 0 ? "last" : "first" }}>
						...
						>
							click here&nbsp;
							<svg xmlns="http://www.w3.org/2000/svg" class="bi" width={14} aria-hidden="true" viewBox="0 0 512 512"><path d="M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" /></svg>
						</Link>
					</Col>
				</Row>
			))}
